...
for e in range(n_experiments):
    ...
    env = JointEnvironment(bids=bids, prices=prices, considered_classes=customer_classes)
    ...
    print('Pulled Bid: ', pulled_arm_bid)
    print('Pulled Price: ', pulled_arm_price)

    joint_rewards_per_experiment.append(ts_learner.collected_objective_function)
